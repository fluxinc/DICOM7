...
Source: "..\ORM2DICOM\bin\Release\*.*"; DestDir: "{app}"; Flags: ignoreversion;
...
Source: "Input\ORM2DICOM.WinSW.xml"; DestDir: "{app}"; Flags: ignoreversion;
Source: "..\ORM2DICOM\config.yaml"; DestDir: "{#MyAppDataDir}\ORM2DICOM"; DestName: config.yaml; Flags: onlyifdoesntexist confirmoverwrite;



[Run]
Filename: "{sys}\sc.exe"; Parameters: "stop DICOM7_DICOM2ORM"; Description: "Stopping existing service"; WorkingDir: {app}; Check: IsServiceRunning('DICOM7_DICOM2ORM');
Filename: "{sys}\sc.exe"; Parameters: "delete DICOM7_DICOM2ORM"; Description: "Removing existing service"; WorkingDir: {app}; Flags: runhidden;
Filename: "{app}\WinSW-x64.exe"; Parameters: "install ""{app}\DICOM2ORM.WinSW.xml"""; Description: "Installing DICOM7_DICOM2ORM service"; WorkingDir: {app}; Flags: runhidden;

Filename: "{sys}\sc.exe"; Parameters: "stop DICOM7_DICOM2ORU"; Description: "Stopping existing service"; WorkingDir: {app}; Check: IsServiceRunning('DICOM7_DICOM2ORU');
Filename: "{sys}\sc.exe"; Parameters: "delete DICOM7_DICOM2ORU"; Description: "Removing existing service"; WorkingDir: {app}; Flags: runhidden;
Filename: "{app}\WinSW-x64.exe"; Parameters: "install ""{app}\DICOM2ORU.WinSW.xml"""; Description: "Installing DICOM7_DICOM2ORU service"; WorkingDir: {app}; Flags: runhidden;

Filename: "{sys}\sc.exe"; Parameters: "stop DICOM7_ORM2DICOM"; Description: "Stopping existing service"; WorkingDir: {app}; Check: IsServiceRunning('DICOM7_ORM2DICOM');
Filename: "{sys}\sc.exe"; Parameters: "delete DICOM7_ORM2DICOM"; Description: "Removing existing service"; WorkingDir: {app}; Flags: runhidden;
Filename: "{app}\WinSW-x64.exe"; Parameters: "install ""{app}\ORM2DICOM.WinSW.xml"""; Description: "Installing DICOM7_ORM2DICOM service"; WorkingDir: {app}; Flags: runhidden;
