...
namespace DICOM7.Shared
{
  public abstract class BasicSCP : DicomService, IDicomServiceProvider, IDicomCEchoProvider
  {
    ...
    public Task OnReceiveAssociationReleaseRequestAsync()
    {
      ...
      catch (ObjectDisposedException e)
      {
        _logger.LogInformation(
          @"ObjectDisposedException in OnReceiveAssociationReleaseRequest: '{EMessage}'\r\n{EStackTrace}", e.Message,
          e.StackTrace);
    ...
    {
      _logger.LogInformation(
        "Association request received from \'{AssociationCallingAE}\' for \'{AssociationCalledAE}\'",
      ...
      try
      {
        ...
        {
          _logger.LogWarning(
            "Invalid called AE \'{AssociationCalledAE}\', expected \'{AeTitle}\'. Rejecting association",
